<div>
    <x-confirmation-modal wire:model="showDeleteModel">
        <x-slot name="title">
            {{ __('app.delete') }} {{ __('subtreatment.subtreatment') }}
        </x-slot>

        <x-slot name="content">
            {{ __('subtreatment.delete question') }}
        </x-slot>
    ...
    <x-confirmation-modal wire:model="showRestoreModel">
        <x-slot name="title">
            {{ __('app.restore') }} {{ __('subtreatment.subtreatment') }}
        </x-slot>
    ...
    <x-confirmation-modal wire:model="showForceDeleteModel">
        ...
        <x-slot name="content">
            {{ __('subtreatment.force delete question') }}
        </x-slot>
