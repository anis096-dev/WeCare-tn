<x-guest-layout>
  <section class="divide-y text-gray-900">
    <!-- header --> 
    <div id="header" class="relative bg-white  dark:text-white dark:bg-gray-900 overflow-hidden pb-2">
            ...
            <div class="relative z-10 pb-8 bg-transparent sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="text-center lg:text-left rtl:lg:text-right">
                        ...
                        <button class="mt-5 sm:mt-8 sm:flex sm:justify-center justify-start animate-pulse p-4 font-bold bg-blue-50 border-4 border-blue-400 rounded-full hover:bg-blue-200 hover:border-blue-600 dark:text-gray-700" >{{__('Booking now!')}}</button>
                    </div>
                </main>
            </div>
        </div>
          ...
          <div class="flex flex-wrap -m-4 text-center">
            ...
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
              <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                ...
                <h2 class="title-font font-medium text-3xl text-gray-900 dark:text-white">{{App\Models\Specialty::count()}}</h2>
            ...
            <div class="p-4 md:w-1/4 sm:w-1/2 w-full">
                <div class="border-2 border-gray-200 px-4 py-6 rounded-lg">
                  ...
                  <h2 class="title-font font-medium text-3xl text-gray-900 dark:text-white">{{App\Models\Treatment::count()}}</h2>
